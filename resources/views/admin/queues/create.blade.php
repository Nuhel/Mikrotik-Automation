                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card  fadeIn3 fadeInBottom">
                            ...
                            <div class="card-body">
                                <form role="form" class="text-start" method="POST" action="{{ route('queue-simple.store') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            @include('admin.input.input_number', ['name' => 'max-limit'])
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            @include('admin.input.input', ['name' => 'interface', 'value' => old('interface')])
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-12">
                                            @include('admin.input.input', ['name' => 'mac-address'])
                                        </div>
                                    </div>
